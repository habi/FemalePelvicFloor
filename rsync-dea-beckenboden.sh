...
rsync --verbose --recursive --update --times --omit-dir-times --exclude="*_rectmp.log" --exclude="*.?if" ~/2214/Beckenboden\ Dea/ ~/research-storage-djonov/Aaldijk/
# 2214 -> Archiv
echo "2214 -> archiv"
...
rsync --verbose --recursive --update --times --omit-dir-times --exclude="*_rectmp.log" --exclude="*.?if" ~/research-storage-djonov/Aaldijk/ /media/habi/Fast_SSD/Aaldijk/
